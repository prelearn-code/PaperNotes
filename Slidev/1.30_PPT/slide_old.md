...
>
> 其中，公钥中的 $s$ 指文件副本个数；$x$ 是真正的私钥，$\alpha$ 是系统私钥（生成公钥后销毁）。
...
<div class="grid grid-cols-[1.2fr_1fr] gap-8 items-center h-[400px]">

<div class="flex flex-col gap-4 relative">

<div class="bg-white p-4 rounded-lg border-l-4 border-blue-500 shadow-md flex justify-between items-center z-10">
<div>
<span class="font-bold text-blue-800">1. 承诺 (Commit)</span>
<div class="text-xs text-gray-500 mt-1">证明者(P) 锁定多项式，生成指纹 <i>C</i> 给验证者(V)</div>
</div>
...
<div class="bg-white p-4 rounded-lg border-l-4 border-purple-500 shadow-md flex justify-between items-center z-10">
<div>
<span class="font-bold text-purple-800">2. 挑战 (Challenge)</span>
<div class="text-xs text-gray-500 mt-1">验证者(V) 随机选一个点 <i>u</i> 发给 P</div>
</div>
<div class="text-2xl">🎲</div>
</div>

<div class="bg-white p-4 rounded-lg border-l-4 border-yellow-500 shadow-md flex justify-between items-center z-10">
<div>
<span class="font-bold text-yellow-800">3. 打开 (Open)</span>
<div class="text-xs text-gray-500 mt-1">P 计算结果 <i>v = f(u)</i>，并生成证明 <i>π</i></div>
</div>
<div class="text-2xl">🧾</div>
</div>

<div class="bg-white p-4 rounded-lg border-l-4 border-green-500 shadow-md flex justify-between items-center z-10">
<div>
<span class="font-bold text-green-800">4. 验证 (Verify)</span>
<div class="text-xs text-gray-500 mt-1">V 检查证明 <i>π</i> 是否匹配承诺 <i>C</i> 和结果 <i>v</i></div>
</div>
<div class="text-2xl">✅</div>
</div>
...
<div class="bg-gray-900 text-gray-100 p-6 rounded-xl shadow-2xl h-full flex flex-col justify-center font-mono text-sm leading-relaxed border border-gray-700">
<div class="text-center border-b border-gray-700 pb-2 mb-4 text-gray-400 font-bold">
Example: KZG Commitment
</div>
<div class="space-y-4">
<div>
<span class="text-blue-400"># 1. Secret Polynomial</span><br>
f(x) = <span class="text-yellow-300">x² + 3</span>
</div>
<div>
<span class="text-blue-400"># 2. Commitment</span><br>
C = <span class="text-green-400">0xAbC...123</span> (Hash of f)
</div>
<div>
<span class="text-blue-400"># 3. Challenge</span><br>
Verifier sends random point: <span class="text-purple-300">x = 10</span>
</div>
<div>
<span class="text-blue-400"># 4. Evaluation & Proof</span><br>
Result: <span class="text-yellow-300">10² + 3 = 103</span><br>
Proof: <span class="text-pink-400">π (Witness)</span>
</div>
<div class="border-t border-gray-700 pt-2 mt-2">
<span class="text-blue-400"># 5. Verify</span><br>
<span class="text-green-500">Check(C, 10, 103, π) == True</span>
</div>
</div>
</div>
