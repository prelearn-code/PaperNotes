...
> **文档状态（2026-09-13）：** 本文是旧框架论文草稿，用于保留已有正文、公式和参考文献，不是当前实现规范。当前研究设计以《核心方案.md》为准，实施与验收以《研究实施与验收.md》为准。正文仍含独立 REP-LINK proof、分离元数据页面、旧生命周期/版本语义和未完成的 RPDP 结论；完成核心实验与证明前不得直接投稿或使用旧图支撑新版贡献。
